...
namespace CompanyNew.Data.Repository
{
    ...
    public class GenericRepository<TEntity> where TEntity : class
    {
        ...
        /// Database context
        /// </summary>
        protected CompanyNewContext context;
        ...
        public GenericRepository(CompanyNewContext dbContext)
        {
            context = dbContext;
        ...
        /// <summary>
        /// Get max value in column ( default comparer)
        /// </summary>
        /// <returns>Entity object</returns>
        public virtual TColumnType Max<TColumnType>(Func<TEntity, TColumnType> selector)
        {
        ...
        public virtual List<TEntity> Find(Expression<Func<TEntity, bool>> filter = null,
                                          string includeProperties = "", string sort = null, bool desc = false, int? page = null, int? pageSize = null)
        {
            IQueryable<TEntity> query = dbSet;
            ...
            {
                query = query.OrderByField(sort, desc);
            }
